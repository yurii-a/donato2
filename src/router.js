...
import DonatoPage from "./pages/DonatoPage.vue";
import BinancePayPage from "./pages/BinancePayPage.vue";
...
const router = new Router({
  routes: [
    ...
    },
    {
      path: "/donato",
      name: "donato",
      components: {default: DonatoPage},
      props: {header: {colorOnScroll: 450}}
    },
    {
      path: "/binancepay",
      name: "binancepay",
      components: {default: BinancePayPage},
      props: {header: {colorOnScroll: 450}}
    },
    {
      path: "/accounts",
      name: "accounts",
      components: {default: AccountDetailsPage},
      props: {header: {colorOnScroll: 450}}
    },
    {
      path: "/components",
